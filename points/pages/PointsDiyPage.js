...
export default class DiyPage extends Component {
	...
	render () {
		...
		return ( <View>
					...
					<View style={ { flexDirection : 'column' } }>
						...
						{ diy_data.data.bottom.mid[ 2 ].goods_info[ 0 ].extend_data != null && (
							<TouchableOpacity activeOpacity={ 1 }
							                  onPress={ () => ViewUtils.goPointsGoodsDetail ( navigation , diy_data.data.bottom.mid[ 2 ].goods_info[ 0 ].gid ) }
							>
								<ImageBackground
									style={ {
										width : width ,
									...
									<View style={ {
										...
										<View style={ {
											...
											<Text style={ {
												color : '#808080' ,
												fontSize : pxToDp ( 20 )
											} }>已团{ diy_data.data.bottom.mid[ 2 ].goods_info[ 0 ].extend_data.buyed_quantity }件</Text>
				...
				{ /*限时活动模版--start*/ }
				{ ( diy_data.type == 'huodong' && diy_data.sele_style == 1 && diy_data.data.bottom.left[ 1 ].goods_info != null && diy_data.data.bottom.mid[ 2 ].goods_info != null && diy_data.data.bottom.right[ 3 ].goods_info != null ) && (
					<View style={ { flexDirection : 'column' } }>
						<TouchableOpacity activeOpacity={ 1 } onPress={ () => {
						...
						<TouchableOpacity activeOpacity={ 1 }
						                  onPress={ () => ViewUtils.goPointsGoodsDetail ( navigation , diy_data.data.bottom.left[ 1 ].gid ) }
						>
							<View style={ { flexDirection : 'row' , width : width , height : pxToDp ( 390 ) } }>
								...
								{ typeof ( diy_data.data.bottom.mid[ 2 ].goods_info[ 0 ].end_time ) != 'undefined' && (
									<TouchableOpacity
										activeOpacity={ 1 }
										onPress={ () => ViewUtils.goPointsGoodsDetail ( navigation , diy_data.data.bottom.mid[ 2 ].gid ) }
										style={ {
											flex : 1 ,
											flexDirection : 'column' ,
											borderRightWidth : 0.5 ,
								...
								{ typeof ( diy_data.data.bottom.right[ 3 ].goods_info[ 0 ].end_time ) != 'undefined' && (
									<TouchableOpacity
										activeOpacity={ 1 }
										onPress={ () => ViewUtils.goPointsGoodsDetail ( navigation , diy_data.data.bottom.right[ 3 ].gid ) }
										style={ {
											flex : 1 ,
											flexDirection : 'column' ,
											borderRightWidth : 0.5 ,
				...
				{ diy_data.type == 'huodong' && diy_data.sele_style == 0 && diy_data.data.left.top[ 0 ].goods_info != null && diy_data.data.right.bottom[ 2 ].goods_info != null && diy_data.data.right.top[ 0 ].goods_info != null && (
					<View style={ { flexDirection : 'column' } }>
						...
						<View style={ { width : width , height : pxToDp ( 470 ) , flexDirection : 'row' } }>
							<TouchableOpacity activeOpacity={ 1 }
							                  onPress={ () => ViewUtils.goPointsGoodsDetail ( navigation , diy_data.data.left.top[ 0 ].goods_info.gid ) }>
								<ImageBackground
									style={ {
										width : pxToDp ( 298 ) ,
										height : pxToDp ( 470 ) ,
									...
									<View style={ [ GlobalStyles.flex_common_row , {
										...
										{ diy_data.data.right.top[ 0 ].goods_info.map ( item => (
											<TouchableOpacity activeOpacity={ 1 } key={ item.gid }
											                  onPress={ () => ViewUtils.goPointsGoodsDetail ( navigation , item.gid ) }>
					...
					<View style={ [ styles.tjsp_small_wrap ] }>
						{ diy_data.data.goods_info != null && diy_data.data.goods_info.map ( ( val , index ) => (
							<TouchableOpacity key={ index } activeOpacity={ 1 }
							                  onPress={ () => ViewUtils.goPointsGoodsDetail ( navigation , val.gid ) }
							                  key={ val.gid }>
									...
									<View style={styles.diy_cart_wrap}>
										<View style={styles.diy_cart}>
											<TouchableOpacity
												...
												activeOpacity={1}
												onPress={()=>this.props.addCart(val.gid)}
											>
												<Image
													resizeMode={'contain'}
											...
											<TouchableOpacity
												...
												activeOpacity={1}
												onPress={()=>this.props.goBuy(val.gid)}
											>
								...
								{ diy_data.data.goods_info.map ( ( item , index ) => (
									<TouchableOpacity activeOpacity={ 1 } key={ 'hw' + index } style={ styles.dapei_part }
										...
										<View style={styles.bw}>
											...
											<Text style={styles.dapei_money_txt}>售价：ks{PriceUtil.formatPrice(item.pgoods_price)}</Text>
										</View>
										...
										<View style={styles.diy_cart_wrap}>
											<View style={styles.diy_cart}>
												<TouchableOpacity
													style={styles.diy_cart_left}
													activeOpacity={1}
													onPress={()=>this.props.addCart(item.gid)}
												>
													<Image
														resizeMode={'contain'}
														style={{width: pxToDp(30),height: pxToDp(30)}}
												...
												<TouchableOpacity
													style={styles.diy_cart_right}
													activeOpacity={1}
													onPress={()=>this.props.goBuy(item.gid)}
												>
													<Text style={{color: '#FEFEFE',fontSize: pxToDp(24)}}>立即兑换</Text>
												</TouchableOpacity>
											</View>
...
const styles = StyleSheet.create ( {
	...
	dapei_part : { flexDirection : 'column' , width : ( width - 40 ) / 2 , marginLeft : 10 , marginTop : 10 } ,
	dapei_part_img : { width : ( width - 40 ) / 2 , height : ( width - 40 ) / 2 } ,
	dapei_part_name : { fontSize : pxToDp ( 30 ) , color : '#141414' , marginTop : 15 } ,
	dapei_part_price : { fontSize : pxToDp ( 30 ) , color : '#EE2328' } ,
