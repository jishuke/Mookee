...
export default class Button extends Component {
    ...
    lineView(){
        ...
        if (this.props.underlineBackgroundColor) {
          var lineView = <View style={{ height: 2, width: 50, alignSelf: "center", bottom: 0, position: "absolute", backgroundColor: this.props.underlineBackgroundColor }} />;
          return lineView;
        }
        return <View />;
    }
    ...
    render() {
        return <TouchableWithoutFeedback style={[this.props.buttonStyle]} activeOpacity={0.6} onLayout={this._onLayout.bind(this)} underlayColor={"transparent"} onPress={() => this.pressHandler()} key={this.props.keyId} disabled={this.props.disabled} ref="btnView">
            <View style={[this.props.contentViewStyle, { flex: 1, alignItems: "center", justifyContent: "center" }]}>
              {this.buttonImage()}
              {this.buttonText()}
              {this.lineView()}
            </View>
