...
export default class SldVideoPlay extends Component {
        ...
        return (
            ...
            <View style={styles.container} onLayout={this._onLayout}>
                ...
                <View style={{
                    ...
                    {/*		<View style={ [ styles.headControl, {width: this.state.videoWidth} ] }>*/}
                    {/*			<TouchableOpacity activeOpacity={ 0.3 } onPress={ () => { ViewUtils.sldHeaderLeftEvent(this.props.navigation) } }>*/}
                    {/*				<Image*/}
                    {/*					tintColor={ '#FFFFFF' }*/}
    ...
    GotoVideoPageEvent() {
        this.pauseVideo();
        this.props.navigation.navigate('SldVideoPage', {
