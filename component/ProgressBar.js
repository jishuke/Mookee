...
export default class CusProgressBar extends Component{
	...
	componentWillReceiveProps(nextProps){
		LogUtil.log('---componentWillReceiveProps');
		LogUtil.log(nextProps);
			...
			<View style={ [ {
				...
				<Animated.View
					...
					<Text style={ {
						color: '#FE483A',
						fontSize: pxToDp(18)
					} }>{ `${ Math.round(this.props.currProgress * 100) }%` }</Text>
					{/*<Image resizeMode={'contain'} style={{width: 15, height: 15, marginLeft:2}} source={require('../assets/images/airplane.png')}/>*/ }
				</Animated.View>
			</View>
		)
	}
